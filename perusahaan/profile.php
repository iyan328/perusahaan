				...
				<div class="row">
                    <div class="col-lg-4">
                        <form role="form" action="" method="post">
							...
							<div class="form-group">
								<label>Alamat</label>
								<input name="alamat" class="form-control" value="<?php echo $alamat?>" required>
								<!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
							<div class="form-group">
								<label>No HP</label>
								<input name="no_hp" class="form-control" value="<?php echo $no_hp?>" required>
								<!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
							<div class="form-group">
								<label>E-mail</label>
							...
							<button name="tblEdit" type="submit" class="btn btn-default">Ubah Profile</button>
...
<?php
		...
		if (isset($_POST['tblEdit'])){
			...
			$ket1 = $_POST['ket'];
			$email = $_POST['email'];
			$sql = "UPDATE perusahaan set alamat='$alamat', no_hp='$no_hp', email='$email' where perusahaan='$perusahaan'";
			$kueri = mysql_query($sql);
			if ($kueri){
				echo "<script> alert('Data berhasil diubah');document.location='perusahaan.php'</script>";
			}
			else {
				echo "<script> alert('Data gagal diubah');document.location='profile.php'</script>";
				echo mysql_error();
			}
		}
